...
# Seperti yang telah kita lihat pada materi Latihan Exploratory Data Analysis, 
...
# Nah, untuk mendukung hal ini, kita perlu mengurutkan DataFrame berdasarkan order_date serta memastikan kedua kolom tersebut bertipe datetime.  
...
# Menyimpan data di main_df setelah di filter
...
# Informasi Parameter RFM ( Recency, Frequency, Monetary)
